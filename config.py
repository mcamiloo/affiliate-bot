...
OFFER_HEADLINES: dict[str, list[str]] = {
    "setup_gamer": [
        ...
        "RAGE QUIT LESS, UPGRADE MORE",
        "YOUR SETUP CALLED, IT WANTS AN UPGRADE",
        "RANKED ANXIETY? TRY BETTER GEAR",
        "RETIRE THE POTATO PC EXCUSE",
        "YOUR THUMBS DESERVE BETTER",
        "RGB FIXES EVERYTHING (ALLEGEDLY)",
        "STOP LOSING TO A £15 KEYBOARD",
    ],
    "consoles": [
        "STILL ON THE RESTOCK WAITING LIST?",
        "SOFA GAMING JUST LEVELLED UP",
        "STOP REFRESHING THE RESTOCK PAGE",
        "COUCH CO-OP JUST GOT AN UPGRADE",
        "YOUR BACKLOG CALLED, IT'S GROWING",
        "SCALPERS HATE THIS ONE TRICK",
        "GAME NIGHT JUST GOT SERIOUS",
        "STOP SHARING ONE CONTROLLER",
    ],
    "smart_home": [
        "STOP SHOUTING AT LIGHTS THAT DON'T LISTEN",
        "YOUR HOUSE JUST GOT SMARTER THAN YOU",
        "YOUR LIGHT SWITCH IS OBSOLETE NOW",
        "STOP GETTING UP TO TURN OFF THE LAMP",
        "ALEXA, MAKE MY HOUSE LESS EMBARRASSING",
        "WALK IN THE DARK NO MORE",
        "LAZY? WE PREFER \"AUTOMATED\"",
        "YOUR THERMOSTAT JUST GOT A BRAIN",
        "STOP FUMBLING FOR THE SWITCH AT 2AM",
        "YOUR HOME, NOW ON AUTOPILOT",
    ],
    "audio_wearables": [
        "STOP LOSING ONE EARBUD ON THE TUBE",
        "COMMUTE UPGRADE UNLOCKED",
        "STOP SHOUTING \"WHAT?\" ON CALLS",
        "NOISE-CANCEL YOUR NOSY COWORKERS",
        "YOUR EARS DESERVE AN UPGRADE",
        "SILENCE THE CHAOS, KEEP THE BEAT",
        "STOP UNTANGLING CABLES LIKE IT'S 2010",
        "COMMUTE IN PEACE FOR ONCE",
    ],
    "criadores_de_conteudo": [
        "STOP GOING VIRAL FOR THE WRONG REASONS (POTATO CAM)",
        'NO MORE "CAN YOU HEAR ME?" EVERY 5 MINUTES',
        "YOUR STREAM QUALITY CALLED, IT'S TIRED OF EXCUSES",
        "STOP BUFFERING YOUR OWN CONTENT",
        "LOOK LESS LIKE A HOSTAGE VIDEO",
        "YOUR MIC DESERVES BETTER THAN THAT ECHO",
        "GO FROM POTATO TO PRO",
        "STOP APOLOGISING FOR THE AUDIO",
    ],
    "default": [
        "BARGAIN ALERT",
        "TOO GOOD TO SCROLL PAST",
        "YOUR WALLET WILL THANK YOU",
        "DEAL SO GOOD IT FEELS ILLEGAL",
        "BLINK AND IT'S GONE",
        "TREAT YOURSELF, IT'S ON SALE",
        "SCROLL STOPPER ALERT",
        "OKAY, THIS ONE'S ACTUALLY WORTH IT",
        "ADD TO CART BEFORE YOU OVERTHINK IT",
        "PRICE DROP, NO CATCH",
    ],
}
